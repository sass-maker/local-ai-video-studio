...
public struct EffectDefinition: Equatable, Sendable {
  ...
  public var defaultParameters: EffectParameters {
    EffectParameters(
      ...
      preset: type == .captionDynamic
        ? "bold" : (type == .backgroundReplace ? "soft_gradient" : nil),
  ...
  public var textParameters: [EffectTextParameterDescriptor] {
    ...
    case .backgroundReplace:
      [
        .init(
          kind: .preset, defaultValue: "soft_gradient",
          options: ["soft_gradient", "studio_dark", "paper"])
      ]
    default:
      []
    }
...
public struct EffectRegistry: Sendable {
  ...
  public static let standard = EffectRegistry(
    definitions: EffectType.allCases.map { type in
      let styleTypes: Set<EffectType> = [
        .styleAnime, .styleComic, .styleSketch, .styleWatercolor, .styleCel, .styleCinematic,
        .styleNoir, .styleVHS,
      ]
      let mediumTypes: Set<EffectType> = [
        .backgroundBlur, .backgroundReplace, .outline, .glow, .beatFlash, .beatZoom,
        .transitionCrossfade,
      ]
...
extension EffectType {
  ...
  public var category: EffectCategory {
    ...
    case .colorGrade, .styleAnime, .styleComic, .styleSketch, .styleWatercolor, .styleCel,
